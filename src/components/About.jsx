  ...
  return (
    <section className="w-full py-10 md:py-20 bg-[#FDF2D2]">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-12 px-6 md:px-12">
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-start">
          <div className="relative w-[280px] h-[360px] sm:w-[320px] sm:h-[420px] md:w-[380px] md:h-[480px] lg:w-[460px] lg:h-[580px]">
            ...
            <img
              src={aboutImg}
              alt="About"
              className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[88%] h-auto object-cover rounded-2xl"
            />
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-gray-800 leading-tight">
            ARJUN SAJNANI
          </h2>
              ...
              <p className="font-ABeeZee text-gray-600 text-base md:text-lg leading-7 md:leading-8">
                ...
                created to bring the restaurant’s signature flavours into everyday kitchens.
                 Inspired by years of crafting honest, ingredient-forward food,
                  each sauce and dressing is made with the same focus on freshness, balance, and purity. 
                  The line was born from a simple idea, bottling the familiar, 
                  comforting taste of Sunny’s so people could enjoy its flavours at home, anytime, 
                  with the same authenticity the restaurant is known for.
              </p>
            )}
